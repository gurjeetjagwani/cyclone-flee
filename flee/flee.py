...
class Person:
    ...
    def evolve(self, time:int, ForceTownMove: bool = False) -> None:
        ...
        Args:
            ...
            windspeed(int): Description
        """
        #windspeed = random.randrange(0,115)
        #print(f"windspeed is {windspeed}")

        if self.travelling is False and self.location.camp is False:
            #change the movechance probability of the agent according to the windspeed
            if Ecosystem.windspeed >= 90:
                movechance = 1.0
            elif Ecosystem.windspeed >= 80:
                movechance = 0.8
            elif Ecosystem.windspeed >= 70:
                movechance = 0.7
            elif Ecosystem.windspeed >= 60:
                movechance = 0.6
            elif Ecosystem.windspeed >= 50:
                movechance = 0.5
            elif Ecosystem.windspeed >= 40: 
                movechance = 0.4
            else :
                movechance = 0.001

            outcome = random.random()
            #print(f"movechance is {movechance}")
        ...
        elif self.travelling is False and self.location.camp is True:
            #print(f"agent is in {self.location.name}")
            if Ecosystem.windspeed <= 40:
                movechance = 0.3
            elif Ecosystem.windspeed <=80:
                movechance = 0.1
            else:
