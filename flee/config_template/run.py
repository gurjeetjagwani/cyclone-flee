...
if __name__ == "__main__":
    ...
    d = handle_refugee_data.RefugeeTable( csvformat="generic", data_directory="config_template/source_data/",start_date="2012-08-13",data_layout="data_layout.csv")
